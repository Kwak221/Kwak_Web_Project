    ...
    return (
        <div>
            ...
            <div style={{ visibility: show ? "visible" : "hidden" }} className="About-Info">
                ...
                Front-End: All front end work was done using the React framework. React is a style of interfacing<br/>
                ...
                Back-End: Backend work was done with the Express Framework. Express is a web framework written in Javascript <br/>
                ...
                Connecting Front and Back: Used to connect the two ends was CORS. CORS, which stands for <br/>
                ...
                Database: The database used was MongoDB, but in a style of Mongoose. MongoDB is a shapeless schema database<br/> 
                ...
                All work was done by Sean Kwak, and not copied, cheating or stolen from outside sources. <br/>
            </div>
        </div>
    );
};
